...
tag <- "noExtinction"
repo_path <- "Shaw_virus"
repo <- "Shaw"
reso <- 1/6
reso_txt <- "Reso_sixth"
all_viruses_gam <- readRDS(paste0(base_dir, "intermediates/noExtinction_shaw_virus_models_poisson.rds"))$model[[1]]
hp3_hosts <- read_rds(paste0(base_dir, "intermediates/Shaw_virus_dataset.rds"))
...
viruses_missing <- readRDS(paste0(base_dir, "maps/", tag, "-", reso_txt, "-map_intermediate_", repo, "-", "viruses-missing"))
viruses_number <- readRDS(paste0(base_dir, "maps/", tag, "-", reso_txt, "-map_intermediate_", repo, "-", "viruses-number"))
viruses_observed <- readRDS(paste0(base_dir, "maps/", tag, "-", reso_txt, "-map_intermediate_", repo, "-", "viruses-observed"))
viruses_predicted <- readRDS(paste0(base_dir, "maps/", tag, "-", reso_txt, "-map_intermediate_", repo, "-", "viruses-predicted"))
viruses_predicted_max <- readRDS(paste0(base_dir, "maps/", tag, "-", reso_txt, "-map_intermediate_", repo, "-", "viruses-predicted_max"))
viruses_resid <- readRDS(paste0(base_dir, "maps/", tag, "-", reso_txt, "-map_intermediate_", repo, "-", "viruses-resid"))
...
carn_viruses_bias <- readRDS(paste0(base_dir, "maps/", tag, "-", reso_txt, "-", "map_intermediate_", repo, "-viruses-CARNIVORA-BIAS"))
cert_viruses_bias <- readRDS(paste0(base_dir, "maps/", tag, "-", reso_txt, "-", "map_intermediate_", repo, "-viruses-CETARTIODACTYLA-BIAS"))
chir_viruses_bias <- readRDS(paste0(base_dir, "maps/", tag, "-", reso_txt, "-", "map_intermediate_", repo, "-viruses-CHIROPTERA-BIAS"))
prim_viruses_bias <- readRDS(paste0(base_dir, "maps/", tag, "-", reso_txt, "-", "map_intermediate_", repo, "-viruses-PRIMATES-BIAS"))
rode_viruses_bias <- readRDS(paste0(base_dir, "maps/", tag, "-", reso_txt, "-", "map_intermediate_", repo, "-viruses-RODENTIA-BIAS"))
all_viruses_bias <- readRDS(paste0(base_dir, "maps/", tag, "-", reso_txt, "-", "map_intermediate_", repo, "-viruses-ALL-BIAS"))
...
saveRDS(rasters4, paste0(base_dir, "intermediates/", tag, "-Shaw_virus_rasters_ALL.rds"))
