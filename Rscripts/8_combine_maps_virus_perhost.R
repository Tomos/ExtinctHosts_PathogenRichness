...
noExtinction_shaw_raster <- readRDS(paste0(base_dir, "intermediates/noExtinction-Shaw_virus_rasters_ALL.rds"))
Extinction_shaw_raster <- readRDS(paste0(base_dir, "intermediates/Extinction-Shaw_virus_rasters_ALL.rds"))
...
#plot(diff_plot1)
ggsave(paste0(base_dir,"Figures/Shaw_", map_type, "_virus_withVSwithout_extinction-carnivora.png"), diff_plot1, dpi = 500, width = 15, height = 8)
#dev.off()

legend_title <- "Percentage difference in\nviral richness with vs\nwithout extinctions"
diff_plot1 <- diff_plot1 + 
  scale_fill_stepsn(legend_title,
                    colours=c("darkslateblue", "cornflowerblue", "white", "coral1", "darkred"),
                    breaks=seq(-max_for_graphing, max_for_graphing, by=step_size),
...
ggsave(paste0(base_dir,"Figures/Shaw_", map_type, "_virus_withVSwithout_extinction-cetartiodactyla.png"), diff_plot2, dpi = 500, width = 15, height = 8)
#dev.off()
...
ggsave(paste0(base_dir,"Figures/Shaw_", map_type, "_virus_withVSwithout_extinction-chiroptera.png"), diff_plot3, dpi = 500, width = 15, height = 8)
#dev.off()
...
ggsave(paste0(base_dir,"Figures/Shaw_", map_type, "_virus_withVSwithout_extinction-primates.png"), diff_plot4, dpi = 500, width = 15, height = 8)
#dev.off()
...
ggsave(paste0(base_dir,"Figures/Shaw_", map_type, "_virus_withVSwithout_extinction-rodentia.png"), diff_plot5, dpi = 500, width = 15, height = 8)
#dev.off()
...
ggsave(file=paste0(base_dir, "Figures/", map_type, "_virus_perOrder_combined.png"), combined_plot, dpi = 500, width = 15, height = 40)
